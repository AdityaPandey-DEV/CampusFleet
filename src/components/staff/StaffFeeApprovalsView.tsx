        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400">
              Verify bank UTRs, inspect payment receipt photos, and issue campus bus passes.
            </p>
          </div>
                  ...
                  <div className="flex items-start gap-3.5 min-w-0 flex-1">
                    ...
                    {sub.receipt_url ? (
                      <div
                        ...
                        className="w-14 h-14 rounded-xl overflow-hidden border border-slate-200 dark:border-slate-700 bg-slate-100 dark:bg-slate-800 flex-shrink-0 cursor-pointer relative group shadow-sm"
                      >
                        <img
                          src={sub.receipt_url}
                          alt="Receipt"
