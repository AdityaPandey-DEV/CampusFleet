  ...
  return (
    <div className="space-y-6 animate-in fade-in">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl p-5 sm:p-6 border border-slate-200 dark:border-slate-800 shadow-md">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <button
            ...
            className="p-2.5 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 rounded-xl text-xs font-bold flex items-center gap-1.5 transition-colors cursor-pointer self-start sm:self-auto"
          >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        <div className="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm flex items-center justify-between">
          <div>
            ...
            <div className="text-[10px] text-slate-400 font-mono mt-0.5">Active corridor riders</div>
          </div>
        ...
        <div className="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm flex items-center justify-between">
          <div>
            ...
            <div className="text-[10px] text-slate-400 font-mono mt-0.5">With 10% peak surge buffer</div>
          </div>
          <div className="w-10 h-10 rounded-xl bg-blue-50 dark:bg-blue-950/60 text-blue-600 flex items-center justify-center">
        ...
        <div className="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm flex items-center justify-between">
          <div>
            ...
            <div className="text-[10px] text-slate-400 font-mono mt-0.5">Assigned to corridors</div>
          </div>
      ...
      {isLoadingAnalytics ? (
        ...
        <div className="py-16 text-center text-xs text-slate-400 font-mono space-y-2 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {routeAnalytics.map((item) => {
            ...
            return (
              <div
                key={item.routeId}
                className="bg-white dark:bg-slate-900 rounded-3xl p-5 border border-slate-200 dark:border-slate-800 shadow-md space-y-4 hover:shadow-lg transition-shadow"
              >
                ...
                <div className="grid grid-cols-3 gap-2.5 p-3.5 bg-slate-50 dark:bg-slate-950 rounded-2xl border border-slate-200 dark:border-slate-800 text-center">
                  <div>
                    ...
                    <div className="text-[9px] text-slate-400">{item.paidStudents || 0} Paid</div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="text-[9px] text-slate-400">{item.utilizationRate || 0}% Utilized</div>
                  </div>
                </div>
                ...
                <div className="space-y-1.5 pt-1">
                  <div className="text-[11px] font-bold text-slate-700 dark:text-slate-300 flex items-center justify-between">
                    ...
                    <span className="font-mono text-[10px] text-slate-400">{item.stops?.length || 0} Stops</span>
                  </div>
