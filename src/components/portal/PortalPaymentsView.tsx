      ...
      {isPassApproved ? (
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 sm:p-10 border border-gray-200 dark:border-gray-800 shadow-sm flex flex-col items-center justify-center text-center space-y-5">
           ...
           <button
             ...
             className="w-full max-w-sm py-4 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold text-base flex items-center justify-center gap-2 shadow-sm transition-all disabled:opacity-50"
           >
             {isRazorpayLoading ? (
