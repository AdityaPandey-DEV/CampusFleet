...
export default function CampusFleetLandingPage() {
  ...
  return (
    <div className="min-h-screen relative text-slate-900 dark:text-slate-100 flex flex-col justify-between selection:bg-blue-500 selection:text-white w-full max-w-[100vw] overflow-x-hidden">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-14 space-y-16 sm:space-y-24 flex-1">
        
        {/* HERO SECTION */}
        <div className="text-center space-y-6 max-w-3xl mx-auto pt-2 sm:pt-6">
          {/* Institutional Trust Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50/90 dark:bg-blue-950/80 text-blue-700 dark:text-blue-300 text-xs font-black border border-blue-200/80 dark:border-blue-800/80 shadow-xs animate-pulse">
            <Sparkles className="w-3.5 h-3.5 text-blue-600 dark:text-blue-400" />
            <span>Dedicated University Transit Solution for Students & Parents</span>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
            <Link
              href={getDashboardLink()}
              className="px-6 py-3.5 bg-blue-600 hover:bg-blue-500 text-white font-black text-sm rounded-2xl shadow-xl shadow-blue-600/30 flex items-center gap-2 transition-all active:scale-95"
            >
            ...
            <Link
              href="/portal/booking"
              className="px-6 py-3.5 bg-white/90 dark:bg-slate-800/90 hover:bg-slate-100 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 font-bold text-sm rounded-2xl border border-slate-200/90 dark:border-slate-700/80 shadow-sm flex items-center gap-2 transition-all backdrop-blur-md"
            >
              <BusFront className="w-4 h-4 text-indigo-600 dark:text-indigo-400" />
              <span>Reserve Bus Seat</span>
            </Link>

            <Link
              href="/portal/pass"
              className="px-6 py-3.5 bg-slate-100/90 dark:bg-slate-800/60 hover:bg-slate-200/90 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300 font-bold text-sm rounded-2xl border border-slate-200/60 dark:border-slate-700/60 transition-all backdrop-blur-md"
            >
          ...
          <div className="pt-4 flex flex-wrap items-center justify-center gap-6 sm:gap-10 text-xs font-bold text-slate-500 dark:text-slate-400">
            <div className="flex items-center gap-1.5">
              <CheckCircle2 className="w-4 h-4 text-emerald-500" />
              <span>100% Guaranteed Reserved Seating</span>
            </div>
            <div className="flex items-center gap-1.5">
              <Radio className="w-4 h-4 text-blue-500 animate-pulse" />
              <span>15s Live GPS Telemetry</span>
            </div>
            <div className="flex items-center gap-1.5">
              <ShieldCheck className="w-4 h-4 text-purple-500" />
              <span>Parent Boarding Alerts</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 text-white rounded-3xl sm:rounded-[2.5rem] p-8 sm:p-14 text-center space-y-6 shadow-2xl relative overflow-hidden">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            <Link
              href={getDashboardLink()}
              className="px-8 py-3.5 bg-white text-blue-600 hover:bg-blue-50 font-black text-sm rounded-2xl shadow-xl transition-all active:scale-95 flex items-center gap-2"
            >
            ...
            <Link
              href="/portal/booking"
              className="px-8 py-3.5 bg-blue-900/50 hover:bg-blue-900/70 text-white font-bold text-sm rounded-2xl border border-white/20 transition-all active:scale-95"
            >
      ...
      {/* FOOTER */}
      <footer className="border-t border-slate-200/80 dark:border-slate-800/80 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          ...
          <div className="border-t border-slate-100 dark:border-slate-800/80 pt-4 flex flex-col sm:flex-row items-center justify-between gap-3 text-[11px] text-slate-400">
            ...
            <div className="flex items-center gap-3 font-mono">
              <span className="text-slate-400">Institutional Access:</span>
