              ...
              <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                {payments.map((pay) => (
                  <tr key={pay.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/30">
                    <td className="p-3 font-mono font-bold text-blue-600">{pay.receiptNumber}</td>
                    <td className="p-3 font-medium">{pay.studentName}</td>
                    <td className="p-3 text-slate-500">{pay.planName}</td>
                    <td className="p-3 font-black font-mono">{formatCurrency(pay.amount)}</td>
                    <td className="p-3 font-mono text-slate-400">{pay.transactionRef}</td>
                    <td className="p-3 text-slate-500">{formatDate(pay.createdAt)}</td>
                    <td className="p-3">
