...
/**
 * Server Component: Staff Operations & Fleet Command Gateway
 * - Performs server-side cryptographic JWT authorization
 * - Fetches fleet rosters, trips, bookings, routes, and billing manifests directly from PostgreSQL
 * - Streams pre-rendered HTML for instant dashboard interaction with zero load latency
 */
